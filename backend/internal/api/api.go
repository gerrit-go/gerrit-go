...
func (s *Server) routes() {
	...
	mux.HandleFunc("GET /accounts/self/queries", s.requireAuth(s.handleListSavedQueries))
	mux.HandleFunc("POST /accounts/self/queries", s.requireAuth(s.handleCreateSavedQuery))
	mux.HandleFunc("DELETE /accounts/self/queries/{id}", s.requireAuth(s.handleDeleteSavedQuery))
