...
var enMessages = map[string]string{
	...
	"msg.psEditPublished":     "Uploaded patch set %d (published from a change edit).",
	"msg.psEditPublishedNotify": "%s published an edit as patch set %d.",
...
var zhMessages = map[string]string{
	...
	"msg.psEditPublished":     "已上传补丁集 %d（从变更编辑发布）。",
	"msg.psEditPublishedNotify": "%s 将编辑发布为补丁集 %d。",
